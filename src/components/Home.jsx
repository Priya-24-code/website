        ...
        <div className=" bg-[url(/pic.png)] sm:bg-[url(/backgroundImg.png)] bg-cover bg-center bg-fixed">
            <section className="bg-white/85 dark:bg-tertiary/65 py-56 px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p className="text-xl mb-8 max-w-2xl mx-auto font-semibold">
                    Unleash your coding potential and build amazing projects
                    with our vibrant community of developers.
                </p>
                <button
                    className={
            ...
            <section className={"py-16 px-4 sm:px-6 lg:px-8" + " base-theme"}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    <div className="bg-stone-100 dark:bg-tertiary p-6 rounded-lg shadow-lg">
                        ...
                        <p className="text-sm">
                            Collaborate on exciting projects and learn from
                    ...
                    <div className="bg-stone-100 dark:bg-tertiary p-6 rounded-lg shadow-lg">
                        ...
                        <p className="text-sm">
                            ...
                            hackathons, and hands-on projects across various
                            technologies.
                        </p>
                    </div>
                    <div className="bg-stone-100 dark:bg-tertiary p-6 rounded-lg shadow-lg">
                        ...
                        <p className="text-sm">
                            Connect with like-minded individuals, industry
                            professionals, and potential employers in the tech
                            world.
                        </p>
                    </div>
