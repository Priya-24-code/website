...
function ContactUs() {
	return (
		<div className="flex-1 max-w-screen-2xl min-h-screen mx-auto flex items-center justify-center p-2">
			<div
				className={
					"shadow-2xl rounded-lg overflow-hidden border dark:border-stone-500" + " base-theme border-theme"
				}
			>
						...
						<div className="space-y-4">
							<div className="flex items-start">
								...
								<div>
									...
									<p className="text-sm">
										Accurate Institute of Management and Technology, Knowledge park 3, Gautam Buddha
										Nagar, Greater Noida
									</p>
