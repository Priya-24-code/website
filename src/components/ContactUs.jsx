...
const ContactUs = () => {
  ...
  <div className="max-w-4xl">
    <div className="bg-white shadow-2xl rounded-lg overflow-hidden">
      <div className="md:flex backdrop-blur-md"> {/* Apply backdrop-blur here */}
        ...
        <div className="md:w-1/2 p-8 ">
          ...
          <form>
            ...
            <div className="mb-4">
              ...
              <textarea id="message" name="message" rows={4} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder='Message sending is not working for now will implement in hacktoberfest.' required></textarea>
            </div>
