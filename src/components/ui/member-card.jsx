...
function MemberCard({ img, name, about, portfolio, githubProfile, linkedinProfile, courseYear }) {
	return (
		<div
			className={
		...
		>
			...
			<div className="mt-4 p-4 flex-1 flex flex-col items-start justify-center gap-2">
				...
				<p className="text-sm w-full h-20 text-ellipsis overflow-hidden">{about}</p>
