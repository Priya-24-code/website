		...
		<main className={"p-6 sm:p-10 relative w-full max-w-screen-2xl mx-auto" + " base-theme"}>
			...
			<section className="mb-16">
				...
				<p className="text-lg mb-6">
					At Emulation Club, we strive to create a vibrant community of passionate developers who are
					dedicated to pushing the boundaries of software emulation. Our mission is to preserve digital
					history, enhance gaming experiences, and foster innovation in the field of emulation technology.
				</p>
			...
			<section className="mb-16">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					<div className="bg-stone-100 dark:bg-tertiary p-6 rounded-lg shadow-lg">
						...
						<p className="text-sm">
							We uphold the highest ethical standards in our emulation practices and respect intellectual
							property rights.
						</p>
					</div>
					<div className="bg-stone-100 dark:bg-tertiary p-6 rounded-lg shadow-lg">
						...
						<p className="text-sm">
							We foster a supportive and inclusive environment where members can learn, share, and grow
							together.
						</p>
					</div>
					<div className="bg-stone-100 dark:bg-tertiary p-6 rounded-lg shadow-lg">
						...
						<p className="text-sm">
							We encourage creative problem-solving and push the boundaries of what&apos;s possible in
